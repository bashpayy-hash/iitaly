...
const STAGES = [
  {
    ...
    tasks: [
      ...
      {
        id: "chances",
        t: "Понять шансы на стипендию и льготы",
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        id: "cimea",
        t: "Получить признание аттестата (CIMEA)",
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        id: "universitaly",
        t: "Подтвердить поступление на гос. портале (Universitaly)",
  ...
  {
    id: "dsu",
    title: "Стипендия и льготы (DSU)",
    skipIf: (p) => p.budget === "Без ограничений",
    tasks: [
      {
        id: "familyDocs",
        t: "Собрать семейные справки для стипендии",
      ...
      {
        id: "iseeu",
        t: "Оформить справку о доходах для стипендии (ISEEU)",
      ...
      {
        id: "dsuApply",
        t: "Подать заявку на стипендию региона",
